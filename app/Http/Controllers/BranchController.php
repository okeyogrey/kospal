...
use App\Services\PlanBranchCapService;
...
{
    public function index(TenantContext $tenant, FeatureFlagService $limits, PlanBranchCapService $branchCaps): Response
    {
        ...
        return Inertia::render('branches/index', [
            'branches' => $branches->map(function (Branch $branch) use ($branchCaps, $business) {
                $branch->setRelation('business', $business);
                ...
                return [
                    ...
                    'can_reopen' => $branchCaps->canReopen($branch),
