...
export default function SupplierPaymentsShow({
    payment,
    activity,
}: {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <Button variant="outline" asChild>
                        <Link href="/supplier-payments">All payments</Link>
                    </Button>
                </div>
                        ...
                        <section className="space-y-3">
                            ...
                            <div className="divide-y rounded-lg border border-border/80">
                                {payment.allocations.map((alloc) => (
                                    ...
                                    >
                                        <Link
                                            href={`/supplier-invoices/${alloc.invoice_id}`}
                                            className="font-medium hover:underline"
                                        >
                                            {alloc.invoice_reference ??
                                                `#${alloc.invoice_id}`}
                                        </Link>
